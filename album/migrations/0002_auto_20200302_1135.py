# -*- coding: utf-8 -*-
# Generated by Django 1.11 on 2020-03-02 08:35
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='article',
            name='editor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='album.Editor'),
        ),
        migrations.AddField(
            model_name='article',
            name='location',
        ...
        migrations.AddField(
            model_name='article',
            name='tags',
            field=models.ManyToManyField(to='album.tags'),
        ),
    ]
